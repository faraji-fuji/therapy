<x-application>
    ...
    <div data-draggable="true" style="position: relative;">
        ...
        <section draggable="false" class="overflow-hidden pt-0" data-v-271253ee="">
            <section class="mb-5">
                <!-- Background image -->
                <div class="p-5 text-center bg-image" style="background-image: url(/storage/{{ $service->image }} ); height: 500px; background-size: cover; background-position: 50% 50%; background-color: rgba(0, 0, 0, 0);" aria-controls="#picker-editor"></div>
                <!-- Background image -->
                <div class="container">
                    <div class="card mx-4 mx-md-5 text-center shadow-5-strong" style=" margin-top: -170px; background: hsla(0, 0%, 100%, 0.5); backdrop-filter: blur(30px); ">
                        <div class="card-body px-4 py-5 px-md-5">
                            <h2 class="display-5 ls-tight mb-4 text-uppercase">
                        ...
                        <!-- cards -->
                        <div class="card mb-3 mx-2" style="border-radius: .5rem;">
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body p-4">
                                        ...
                                        <button type="button" class="btn btn-primary btn-rounded  btn-sm"><i class="far fa-clock me-2"></i>Book now</button>
                                    </div>
                                </div>
                            </div>
                        </div>
